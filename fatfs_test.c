...
#include <stdio.h>
#include <string.h>
#include "source/ff.h"         /* Declarations of sector size */
#include "source/diskio.h"     /* Declarations of disk functions */
...
)
{
    ...
    for (cc = 1; cc <= ncyc; cc++) {
        ...
        if (n == sz_sect) {
            ...
            printf(" Read data differs from the data written at %d.\n", n);
            return 10;
        }
        pns++;
...
int main (int argc, char* argv[])
{
    ...
    rc = test_diskio(0, 10, buff, sizeof buff);
